\chapter{Arhitektura i dizajn sustava}
		...
		\section{Dijagram razreda}
			...
			Na slikama \ref{fig:drModels}, \ref{fig:drDataTransferObjects} i \ref{fig:drRepository} su prikazani razredi koji pripadaju \textit{backend} dijelu MVC arhitekture. Na slici \ref{fig:drView} prikazani su razredi \textit{frontend} dijela arhitekture. Razredi prikazani na slici \ref{fig:drRepository} prikazuju \textit{Repository}. Metode implementirane u tim razredima manipuliraju s DTO \textit{(Data transfer object)}, a oni su dohvaćeni pomoću metoda implementiranih u Model razredima.
			...
			\begin{figure}[H]
				\includegraphics[scale=0.55]{dijagrami/dijagramiRazreda/repo.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
