\chapter{Arhitektura i dizajn sustava}
		...
		\section{Dijagram razreda}
			...
			\begin{figure}[H]
				\includegraphics[scale=0.48]{dijagrami/dijagramiRazreda/View1.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.48]{dijagrami/dijagramiRazreda/View2.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.45]{dijagrami/dijagramiRazreda/View3.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
			...
			\begin{figure}[H]
				\includegraphics[scale=0.45]{dijagrami/dijagramiRazreda/dto.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
		...
		\section{Dijagram stanja}
			...
			\begin{figure}[H]
				\includegraphics[scale=0.4]{dijagrami/dijagramStanja/dijagramStanja.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
				\centering
