	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC14 -Pregled korisničkog profila}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } registriran korisnik
						\item  \textbf{Cilj:} pregledati podatke o svom profilu
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} prijava
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item korisnik odabire opciju za prikaz svog profila preko ikone na toolbaru
							\item korisnik pregledava informacije o svom profilu
						\end{packed_enum}
						
					\end{packed_item}
					
					\noindent \underbar{\textbf{UC15 - Pregled liste skloništa}}
					\begin{packed_item}
